...
class Blockchain:
    ...
    def new_block(
        self, proof_of_work: int, prev_block_hash: Optional[str] = None
    ) -> Block:
    ...
    def hash(self, block: Block) -> str:
        ...
        serialized: str = json.dumps(asdict(block), sort_keys=True)
    ...
    def is_valid_proof(self, proof: int, last_proof: int, prev_hash: str) -> bool:
        """
